...
export default class ImageCellMovie extends Lightning.Component {
    static _template() {
        return {
            ...
            ImageWrapper: {w:700, h:500, rtt: true, shader: {type: Lightning.shaders.RoundedRectangle, radius: 4},
                Fill: {w: w => w, h: h => h, color: Colors('White').get(), rect: false},
                Image: {alpha: 0.0001, mount: 0.5, y: w => w / 2, x: h => h / 2},
            },
